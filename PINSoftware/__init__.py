"""
Here is a short overall description. When the program is run, it creates an instance of `PINSoftware.MachineState.MachineState`
...
clicks the start button in the user interface the `PINSoftware.MachineState.MachineState.start_experiment`
